...
class _AddProductToVoucherScreenState extends State<AddProductToVoucherScreen> {
  ...
  AddProductToVoucherController addProductToSaleController = Get.find();
                                          ...
                                          Container(
                                            ...
                                            child: Column(
                                              ...
                                              children: [
                                                ...
                                                Text(
                                                    "${addProductToSaleController.listProduct[index].price}"),
                                              ],
                                            ),
                                          )
                                        ],
                                  ...
                                  Container(
                                    ...
                                    child: Column(
                                      ...
                                      children: [
                                        ...
                                        Text(
                                            "${addProductToSaleController.listProduct[index].price ?? 0} đ"),
                                      ],
                                    ),
                                  )
                                ],
