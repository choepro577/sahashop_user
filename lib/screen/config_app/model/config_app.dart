...
class ConfigApp {
  ...
  factory ConfigApp.fromJson(Map<String, dynamic> json) => ConfigApp(
        ...
        typeOfMenu: int.parse('${json["type_of_menu"]}'),
        ...
        homeIdCarouselAppImage:
            int.parse('${json["home_id_carousel_app_image"]}'),
