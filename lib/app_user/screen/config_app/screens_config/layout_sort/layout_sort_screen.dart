...
import 'package:sahashop_user/app_user/model/attributes.dart';

import 'layout_sort_controller.dart';

class LayoutSortChangeScreen extends StatelessWidget {
  LayoutSortChangeController layoutSortChangeController = new LayoutSortChangeController();
                ...
                : Padding(
                    ...
                    child: Column(
                      children: [
                        Expanded(
                          child: Obx(() {
                            var list = layoutSortChangeController.listLayout
                                .toList();
                            ...
                            return ReorderableListView(
                              ...
                              layoutSortChangeController.changeIndex(oldIndex, newIndex);
                              },
                            );
                          }),
                        ),
