      ...
      Obx(
        () => Container(
          ...
          child: SingleChildScrollView(
            ...
            child: Row(
              children: homeButtonConfigController.listButton.map((e) {
                var index = homeButtonConfigController.listButton.indexOf(e);
                return MaterialButton(
                  ...
                  child: Container(
                    ...
                    decoration: BoxDecoration(
                        ...
                        color:
                            index == homeButtonConfigController.pageType.value
                                ? SahaPrimaryColor
