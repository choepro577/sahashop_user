...
//
//     final allMessageResponse = allMessageResponseFromJson(jsonString);

import 'dart:convert';

import 'package:sahashop_user/app_user/model/message.dart';

AllMessageResponse allMessageResponseFromJson(String str) =>
    AllMessageResponse.fromJson(json.decode(str));

String allMessageResponseToJson(AllMessageResponse data) =>
