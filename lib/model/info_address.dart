...
class InfoAddress {
  ...
  factory InfoAddress.fromJson(Map<String, dynamic> json) => InfoAddress(
        ...
        country: int.parse(json["country"] ?? "0"),
        province: int.parse(json["province"] ?? "0"),
        district: int.parse(json["district"] ?? "0"),
        wards: int.parse(json["wards"] ?? "0"),
        village: json["village"] == "" ? 1 : int.parse(json["village"]),
        postcode: json["postcode"] == "" ? 1 : int.parse(json["postcode"]),
        email: json["email"],
        phone: json["phone"],
