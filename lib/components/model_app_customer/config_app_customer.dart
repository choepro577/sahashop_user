...
ConfigAppCustomer configAppFromJson(String str) =>
    ConfigAppCustomer.fromJson(json.decode(str));

String configAppToJson(ConfigAppCustomer data) => json.encode(data.toJson());

class ConfigAppCustomer {
  ConfigAppCustomer({
    this.logoUrl,
    this.isShowLogo,
    this.colorMain1,
  ...
  factory ConfigAppCustomer.fromJson(Map<String, dynamic> json) =>
      ConfigAppCustomer(
